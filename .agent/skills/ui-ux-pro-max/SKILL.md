---
name: ui-ux-pro-max
description: "UI/UX design intelligence for this Astro + Tailwind repo. BM25 search over styles, colors, typography, products, landing patterns, UX guidelines, charts, icons, and web interface notes; stack slices are html-tailwind and astro only. Use for design, implement, review, or improve UI (layout, a11y, motion, color, type). For WCAG-focused audits prefer the accessibility skill."
---
# UI/UX Pro Max - Design Intelligence

Design guide data for **Astro + Tailwind** in this monorepo: shared CSV corpora (styles, colors, typography, products, landing, UX, charts, icons, web) plus **two** stack guideline files (`html-tailwind`, `astro`). Searchable via the Python CLI with priority-based recommendations.
...
### Step 4: Stack Guidelines (Astro + Tailwind)

Get implementation-specific best practices. Prefer **`astro`** for islands, View Transitions, and content-first patterns; use **`html-tailwind`** for utility-class and responsive layout guidance.

```bash
python3 .agent/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack astro
python3 .agent/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack html-tailwind
```

Available stacks in this repo: **`html-tailwind`**, **`astro`** only.
...
| Stack | Focus |
|-------|-------|
| `html-tailwind` | Tailwind utilities, responsive layout, a11y-oriented patterns |
| `astro` | Content sites, islands, hydration, View Transitions, static vs server |
...
- Stack: `astro` (and `html-tailwind` for utility patterns)
